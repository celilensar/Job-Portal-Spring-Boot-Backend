package com.celilensar.jobportal.exception;

import com.celilensar.jobportal.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ErrorResponseDto> handleException(Exception exception, WebRequest webRequest){
